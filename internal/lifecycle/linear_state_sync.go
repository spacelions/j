...
// the entries into `needs-clarification`: the three foreground exits
// (`EventPlanNeedsClarification`, `EventWorkNeedsClarification`,
// `EventVerifyNeedsClarification`) plus the three reaper-driven
