...
func TestPickSource_Markdown(t *testing.T) {
	...
	res, err := PickSource(context.Background(), ui, []Source{SourceMarkdown, SourceLinear, SourceTask}, nil)
	if err != nil {
		t.Fatalf("err = %v", err)
	}
...
func TestPickSource_Linear(t *testing.T) {
	...
	res, err := PickSource(context.Background(), ui, []Source{SourceMarkdown, SourceLinear}, nil)
	if err != nil {
		t.Fatalf("err = %v", err)
	}
...
func TestPickSource_Task_HappyPath(t *testing.T) {
	...
	res, err := PickSource(context.Background(), ui, []Source{SourceTask}, listTasks)
	if err != nil {
		t.Fatalf("err = %v", err)
	}
...
func TestPickSource_Task_NilListTasks(t *testing.T) {
	...
	_, err := PickSource(context.Background(), ui, []Source{SourceTask}, nil)
...
func TestPickSource_Task_EmptyList(t *testing.T) {
	...
	_, err := PickSource(context.Background(), ui, []Source{SourceTask}, listTasks)
...
func TestPickSource_SelectSourceError(t *testing.T) {
	...
	_, err := PickSource(context.Background(), ui, []Source{SourceMarkdown}, nil)
	if !errors.Is(err, want) {
